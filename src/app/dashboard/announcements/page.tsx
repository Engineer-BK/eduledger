              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1 sm:w-64">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-1.5 bg-paper border border-ink-200 rounded-xl text-xs font-semibold text-ink-900 placeholder:text-ink-400 focus:outline-none focus:border-brass-500"
                  />
                </div>
